...
export const networksSubj: BehaviorSubject<Networks> =
  new BehaviorSubject<Networks>(availableNetworks);
export const selectedNetworkSubj: ReplaySubject<Network> =
  new ReplaySubject<Network>();
selectedNetworkSubj.subscribe((network) =>
