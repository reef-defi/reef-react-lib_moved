...
//       address, supply, symbol1, decimal1, decimal2, symbol2, volume_aggregate: { aggregate: { sum: { amount1, amount2 } } },
//     }, index) => (
...
//           {symbol2}
//         </td>
//         <td className="fs-5 text-end">{supply.length > 0 ? formatAmount(supply[0].totalSupply, 18) : 0}</td>
//         <td className="fs-5 text-end">{formatAmount(amount1 || 0, decimal1)}</td>
//         <td className="fs-5 text-end">{formatAmount(amount2 || 0, decimal2)}</td>
//       </tr>
//     ))
//     : [];
