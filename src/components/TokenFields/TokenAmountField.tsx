...
const TokenAmountFieldBase: React.FC<TokenAmountFieldProps> = ({
  id = 'exampleModal', token, tokens, signer, onTokenSelect, onAmountChange, placeholder = '0.0', children, onAddressChange = async () => {}, hideSelectTokenCommonBaseView,
}): JSX.Element => {
  const {
...
export const TokenAmountField = ({
  id, token, tokens, signer, placeholder, onTokenSelect, onAmountChange, onAddressChange,
...
export const TokenAmountFieldMax = ({
  id, token, tokens, signer, placeholder, onTokenSelect, onAmountChange, onAddressChange, afterBalanceEl, hideSelectTokenCommonBaseView,
...
export const TokenAmountFieldImpactPrice = ({
  id, token, tokens, signer, placeholder, percentage, onTokenSelect, onAmountChange, onAddressChange,
