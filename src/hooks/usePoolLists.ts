...
const queryPoolList = async (args: QueryPoolList): Promise<PoolListItemReq[]> =>
  defaultPoolQuery(ALL_POOLS_LIST_ENDPOINT, args);
...
const calculateUserLiquidity = (
  {token_1, token_2, user_locked_amount_1, user_locked_amount_2, contract_data_1: {decimals: decimal1}, contract_data_2: {decimals: decimal2}}: PoolListItemReq,
  tokenPrices: TokenPrices
): string|undefined => {
