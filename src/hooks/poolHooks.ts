...
export const getPoolTransactionQuery = (address: string | undefined, type: TransactionTypes, limit: number, pageIndex: number): {query: string, variables: any} => ({
...
export const usePoolTransactionCountSubscription = (
  ...
  useEffect(() => {
    ...
    graphqlRequest(httpClient, queryObj)
      .then((response) => {
