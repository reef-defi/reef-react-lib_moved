...
import { PoolLPQuery, PoolsTotalSupplyQuery, POOLS_TOTAL_SUPPLY, PoolUserLPQuery, PoolUserLpVar, PoolVar, POOL_TOTAL_SUPPLY, POOL_USER_LP, UserPoolsQuery, UserPoolsVar, USER_POOLS } from "../graphql/pools";
